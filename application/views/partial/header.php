...
<html lang="en">
	<head>
		...
		<!-- <link rel="stylesheet" href="<?php //echo base_url('asset/css/csku.css')?>"> -->
...
<!--external css-->
		...
		<!-- <script type="text/javascript" src="<?php //echo base_url('asset/datatables/media/js/jquery.js')?>"/></script> -->
		<script type="text/javascript" src="<?php echo base_url('asset/datatables/media/js/jquery.dataTables.min.js')?>"/></script>
		<script type="text/javascript" src="<?php echo base_url('asset/datatables/media/js/dataTables.bootstrap.min.js')?>"/></script>
		<!-- <script type="text/javascript" src="<?php //echo base_url('asset/datatables/media/js/bootstrap.min.js')?>"/></script> -->
	...
	<body>
		<section id="container" class="">
			<header class="header dark-bg">
				...
				<a class="logo">
					VISPLANT <span class="lite">BSP</span>
				</a>
          				...
          				<li class="dropdown">
            				<a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            	<span class="profile-ava">
                                	<img alt="" src="<?php echo base_url('asset/img/iconusersmall.jpg')?>"/>
                            	</span>
                            	<span class="username"> Welcome <?php echo $this->session->userdata('nama');?></span>
                            	<b class="caret"></b>
                        	</a>
            				...
            				<ul class="dropdown-menu extended logout">
              					...
              					<!-- <li class="eborder-top">
                					<a href="#"><i class="icon_setting"></i>Setting Kobar</a>
              					</li> -->
              					...
              					<li>
                					<!-- <a href="documentation.html"><i class="icon_key_alt"></i>Log Out</a> -->
              					</li>
            				</ul>
          				</li>
        			</ul>
